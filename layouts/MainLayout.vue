<template>
  <div id="MainLayout" class="w-full fixed z-50">
    <div id="TopMenu" class="w-full bg-[#fafafa] border-b md:block ">
      <ul
        class="flex item-center justify-end text-xs text-[#333] font-light px-2 h-10 bg-[#fafafa] max-w-[1200px]"
      >
        <li
          class="flex items-center border-r border-r-gray-400 px-3 hover:text-[#ff4646] cursor-pointer"
        >
          Sell on AliExpress
        </li>
        <li
    ...
    <div id="MainHeader" class="flex items-center w-full bg-white">
      <div class="flex lg:justify-center justify-between gap-10 max-v-[1150px] w-full px-3 py-5 mx-auto">
         <NuxtLink
            to="/"
            class="min-w-[170px]" 
         >
         ...
         >
            ...
            >
               ...
               <div class="min-w-[40px]">
                  <Icon name="ph:shopping-cart-simple-light" size="33px" :color="isCartHover ? '#ff4646' : ''"/>
               </div>
            </button>
         </NuxtLink>

         <button @click="userStore.isMenuOverlay = true" class="md:hidden block rounded-full p-1.5 -mt-[4px]">
